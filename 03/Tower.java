...
public class Tower{
    ...
    /**Returns an int equal to the height of tower.
     *@return height of the tower
     **/
    public int height(){
        // this.rest.height();
        //how to count number of blocks in a tower
    ...
    /**Returns an int equal to the number of blocks to c.
     *@param c blocks in the tower
     *@return number of blocks equal to c in a tower
     **/
